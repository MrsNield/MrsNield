...
const SITE_DATA = {
  ...
  honors: {
    ...
    boardWork: [
      ...
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (2nd period)", image: "images/board/2026-09-03_continuity-endbehavior1_2nd.jpg" },
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (2nd period)", image: "images/board/2026-09-03_continuity-endbehavior2_2nd.jpg" },
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (2nd period)", image: "images/board/2026-09-03_continuity-endbehavior3_2nd.jpg" },
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (2nd period)", image: "images/board/2026-09-03_continuity-endbehavior4_2nd.jpg" },
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (4th period)", image: "images/board/2026-09-03_continuity-endbehavior1_4th.jpg" },
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (4th period)", image: "images/board/2026-09-03_continuity-endbehavior2_4th.jpg" },
      { date: "2026-09-03", caption: "Continuity & End Behavior notes (4th period)", image: "images/board/2026-09-03_continuity-endbehavior3_4th.jpg" }
    ],
    ...
    bellringers: [
      { date: "2026-08-13", number: 1, prompt: "f(x) = x" },
      { date: "2026-08-17", number: 2, prompt: "f(x) = -x" },
      { date: "2026-08-18", number: 3, prompt: "f(x) = x - 2" },
      { date: "2026-08-19", number: 4, prompt: "f(x) = -x + 3" },
      { date: "2026-08-20", number: 5, prompt: "f(x) = 2/3 x + 4" },
      { date: "2026-08-24", number: 6, prompt: "f(x) = -3/2 x - 6" },
      { date: "2026-08-25", number: 7, prompt: "f(x) = x/2 - 1" },
      { date: "2026-08-26", number: 8, prompt: "f(x) = -4" },
      { date: "2026-08-27", number: 9, prompt: "2x + 4y = 8" },
      { date: "2026-08-31", number: 10, prompt: "x - y = 6" },
      { date: "2026-09-01", number: 11, prompt: "-3x - 6y = 12" },
      { date: "2026-09-02", number: 12, prompt: "2x - 5y = 10" },
      { date: "2026-09-03", number: 13, prompt: "y = x + 3 ; y = -x + 3" },
      { date: "2026-09-08", number: 14, prompt: "y = -3/2 x + 6 ; y = x - 4" },
      { date: "2026-09-09", number: 15, prompt: "y = 3/4 x + 6 ; 4y - 3x = -12" },
      { date: "2026-09-10", number: 16, prompt: "x + 2y = -2 ; -2x + y = 4" },
      { date: "2026-09-14", number: 17, prompt: "f(x) = x²" },
      { date: "2026-09-15", number: 18, prompt: "f(x) = -x²" },
      { date: "2026-09-16", number: 19, prompt: "f(x) = x² + 4" },
      { date: "2026-09-17", number: 20, prompt: "f(x) = (x + 5)²" },
      { date: "2026-09-21", number: 21, prompt: "f(x) = (x + 2)² - 4" },
      { date: "2026-09-22", number: 22, prompt: "f(x) = -(x + 1)² + 4" },
      { date: "2026-09-23", number: 23, prompt: "f(x) = -5(x - 1)² + 5" },
      { date: "2026-09-24", number: 24, prompt: "f(x) = 1/2 x² - 8" },
      { date: "2026-09-28", number: 25, prompt: "f(x) = -x(x - 8)" },
      { date: "2026-09-29", number: 26, prompt: "f(x) = (x + 3)(x - 3)" },
      { date: "2026-09-30", number: 27, prompt: "f(x) = x² + 8x + 16" },
      { date: "2026-10-01", number: 28, prompt: "f(x) = x² - 6x + 8" },
      { date: "2026-10-05", number: 29, prompt: "f(x) = |x|" },
      { date: "2026-10-06", number: 30, prompt: "f(x) = |x - 3| - 2" },
      { date: "2026-10-07", number: 31, prompt: "f(x) = |x + 4| - 3" },
      { date: "2026-10-08", number: 32, prompt: "f(x) = -|x + 2| + 4" },
      { date: "2026-10-13", number: 33, prompt: "f(x) = -|x - 2| - 3" },
      { date: "2026-10-14", number: 34, prompt: "f(x) = -1/2 |x + 4|" },
      { date: "2026-10-15", number: 35, prompt: "f(x) = 2|x - 3| - 4" },
      { date: "2026-10-19", number: 36, prompt: "f(x) = -4|x - 2| + 4" },
      { date: "2026-10-20", number: 37, prompt: "f(x) = √x" },
      { date: "2026-10-21", number: 38, prompt: "f(x) = -√x" },
      { date: "2026-10-22", number: 39, prompt: "f(x) = √(x - 3)" },
      { date: "2026-10-26", number: 40, prompt: "f(x) = √x + 2" },
      { date: "2026-10-27", number: 41, prompt: "f(x) = -√x - 5" },
      { date: "2026-10-28", number: 42, prompt: "f(x) = √(x + 1) - 1" },
      { date: "2026-10-29", number: 43, prompt: "f(x) = -√(x + 4) + 1" },
      { date: "2026-11-02", number: 44, prompt: "f(x) = 4√x - 4" },
      { date: "2026-11-03", number: 45, prompt: "f(x) = x³" },
      { date: "2026-11-04", number: 46, prompt: "f(x) = -x³" },
      { date: "2026-11-05", number: 47, prompt: "f(x) = -x³ + 8" },
      { date: "2026-11-09", number: 48, prompt: "f(x) = 1/2 x³ - 4" },
      { date: "2026-11-10", number: 49, prompt: "f(x) = 4(x - 2)³" },
      { date: "2026-11-11", number: 50, prompt: "f(x) = x(x - 2)(x + 2)" },
      { date: "2026-11-12", number: 51, prompt: "f(x) = -x(x - 2)(x - 4)" },
      { date: "2026-11-16", number: 52, prompt: "f(x) = x²(x + 3)" },
      { date: "2026-11-17", number: 53, prompt: "f(x) = x⁴" },
      { date: "2026-11-18", number: 54, prompt: "f(x) = -(x + 3)⁴" },
      { date: "2026-11-19", number: 55, prompt: "f(x) = x(x - 1)(x - 2)(x - 3)" },
      { date: "2026-11-30", number: 56, prompt: "f(x) = -x(x + 1)(x + 2)(x + 3)" },
      { date: "2026-12-01", number: 57, prompt: "f(x) = -x²(x + 3)(x - 3)" },
      { date: "2026-12-02", number: 58, prompt: "f(x) = 1/x" },
      { date: "2026-12-03", number: 59, prompt: "f(x) = -1/x" },
      { date: "2026-12-07", number: 60, prompt: "f(x) = 1/(x+2)" },
      { date: "2026-12-08", number: 61, prompt: "f(x) = 1/(x-2)" },
      { date: "2026-12-09", number: 62, prompt: "f(x) = 1/x + 1" },
      { date: "2026-12-10", number: 63, prompt: "f(x) = 1/x - 1" },
      { date: "2026-12-14", number: 64, prompt: "f(x) = 1/(x+2) - 4" },
      { date: "2026-12-15", number: 65, prompt: "f(x) = -1/(x-2) + 4" },
      { date: "2027-01-05", number: 67, prompt: "f(x) = (x-1)/((x-1)(x-5))" },
      { date: "2027-01-06", number: 68, prompt: "f(x) = (x-2)/(x²-4)" },
      { date: "2027-01-07", number: 69, prompt: "f(x) = (x²-5x+6)/(x²-7x+1)" },
      { date: "2027-01-11", number: 70, prompt: "f(x) = 2<sup>x</sup>" },
      { date: "2027-01-12", number: 71, prompt: "f(x) = (1/2)<sup>x</sup>" },
      { date: "2027-01-13", number: 72, prompt: "f(x) = 2<sup>x</sup> + 3" },
      { date: "2027-01-14", number: 73, prompt: "f(x) = 0.01(2)<sup>x</sup>" },
      { date: "2027-01-19", number: 74, prompt: "f(x) = -4(2)<sup>x</sup>" },
      { date: "2027-01-20", number: 75, prompt: "f(x) = -(2)<sup>x</sup> - 4" },
      { date: "2027-01-21", number: 76, prompt: "f(x) = 3<sup>x</sup> + 2" },
      { date: "2027-01-25", number: 77, prompt: "f(x) = 3<sup>x-5</sup> - 1" },
      { date: "2027-01-26", number: 78, prompt: "f(x) = 4<sup>-x</sup> + 4" },
      { date: "2027-01-27", number: 79, prompt: "f(x) = -(5)<sup>x</sup> + 5" },
      { date: "2027-01-28", number: 80, prompt: "f(x) = 10<sup>x</sup>" },
      { date: "2027-02-01", number: 81, prompt: "f(x) = log x" },
      { date: "2027-02-02", number: 82, prompt: "f(x) = log(x - 4)" },
      { date: "2027-02-03", number: 83, prompt: "f(x) = log(x + 5)" },
      { date: "2027-02-04", number: 84, prompt: "f(x) = log(x + 1) - 1" },
      { date: "2027-02-08", number: 85, prompt: "f(x) = -log x" },
      { date: "2027-02-09", number: 86, prompt: "f(x) = -log(x - 5)" },
      { date: "2027-02-10", number: 87, prompt: "f(x) = -log(x + 6) + 1" },
      { date: "2027-02-11", number: 88, prompt: "f(x) = -2log(x + 1)" },
      { date: "2027-02-16", number: 89, prompt: "f(x) = e<sup>x</sup>" },
      { date: "2027-02-17", number: 90, prompt: "f(x) = ln x" },
      { date: "2027-02-18", number: 91, prompt: "f(x) = e<sup>x</sup> + 4" },
      { date: "2027-02-22", number: 92, prompt: "f(x) = ln(x - 4)" },
      { date: "2027-02-23", number: 93, prompt: "f(x) = e<sup>x</sup> - 3" },
      { date: "2027-02-24", number: 94, prompt: "f(x) = ln(x + 3)" },
      { date: "2027-02-25", number: 95, prompt: "f(x) = 5e<sup>x</sup>" },
      { date: "2027-03-01", number: 96, prompt: "f(x) = -4e<sup>x</sup>" },
      { date: "2027-03-02", number: 97, prompt: "f(x) = 6e<sup>-x</sup>" },
      { date: "2027-03-03", number: 98, prompt: "f(x) = ∛x" },
      { date: "2027-03-04", number: 99, prompt: "f(x) = ∛x + 2" },
      { date: "2027-03-08", number: 100, prompt: "f(x) = |∛x| ; g(x) = -|2/x|" },
      { date: "2027-03-09", number: 101, prompt: "f(x) = ∛(x - 8) + 2" },
      { date: "2027-03-10", number: 102, prompt: "f(x) = -∛(x + 2) - 1" },
      { date: "2027-03-11", number: 103, prompt: "f(x) = -2 ∛(x + 3)" },
      { date: "2027-03-22", number: 104, prompt: "f(x) = 1/2 ∛(x + 4) - 1" },
      { date: "2027-03-23", number: 105, prompt: "f(x) = cos(x)" },
      { date: "2027-03-24", number: 106, prompt: "f(x) = -cos(x)" },
      { date: "2027-03-25", number: 107, prompt: "f(x) = cos(x) - 1" },
      { date: "2027-03-29", number: 108, prompt: "f(x) = 3cos(x)" },
      { date: "2027-03-30", number: 109, prompt: "f(x) = -2cos(x)" },
      { date: "2027-03-31", number: 110, prompt: "f(x) = sin(x)" },
      { date: "2027-04-01", number: 111, prompt: "f(x) = sin(x) + 2" },
      { date: "2027-04-05", number: 112, prompt: "f(x) = sin(x + π)" },
      { date: "2027-04-06", number: 113, prompt: "f(x) = sin(x - π) - 2" },
      { date: "2027-04-07", number: 114, prompt: "f(x) = 3sin(2x)" },
      { date: "2027-04-08", number: 115, prompt: "f(x) = 4sin(x) ; g(x) = -4sin(x)" },
      { date: "2027-04-12", number: 116, prompt: "f(x) = tan(x)" },
      { date: "2027-04-13", number: 117, prompt: "f(x) = -tan(x)" },
      { date: "2027-04-14", number: 118, prompt: "f(x) = tan(x/2)" },
      { date: "2027-04-15", number: 119, prompt: "f(x) = tan(2x)" },
      { date: "2027-04-19", number: 120, prompt: "f(x) = tan(x - π/2)" },
      { date: "2027-04-20", number: 121, prompt: "y = √(25-(x+5)²) ; y = √(25-(x-5)²) ; y = x - 10, 0≥x≥10 ; y = -x - 10, -10≥x≥0" },
      { date: "2027-04-21", number: 122, prompt: "f(r) = 2 · π · r, r > 0" },
      { date: "2027-04-22", number: 123, prompt: "f(r) = π · r², r > 0" },
      { date: "2027-04-26", number: 124, prompt: "f(r) = 4/3 · π · r³, r > 0" },
      { date: "2027-04-27", number: 125, prompt: "y = 3/2 x + 6 ; y = 2 - x/2" },
      { date: "2027-04-28", number: 126, prompt: "f(x) = 2x² + 3x - 5" },
      { date: "2027-04-29", number: 127, prompt: "f(x) = x³ - 1" },
      { date: "2027-05-03", number: 128, prompt: "f(x) = x(x - 1)(x + 2)(x - 3)" },
      { date: "2027-05-04", number: 129, prompt: "f(x) = -8(1/2)<sup>x</sup>" },
      { date: "2027-05-05", number: 130, prompt: "f(x) = 8(1/2)<sup>-x</sup>" },
    ],
  ...
  precalc: {
    ...
    // ---- Downloadable catch-up resources per unit: homework answer keys and
    // filled-in guided notes, for students who missed a lesson. Same
    // { id, name, resources: [{label, file}] } shape as AP Calc's Unit
    // Resources tab (reuses renderApCalcUnits). ----
    unitResources: [
      {
        id: "unit0",
        name: "Unit 0: Prerequisites",
        resources: [
          { label: "Homework Answer Key — 0.1", file: "files/Precalc_Unit0_Homework_0.1_Answer_Key.pdf" },
          { label: "Notes Filled In — 0.1", file: "files/Precalc_Unit0_Notes_0.1_Filled_In.pdf" },
          { label: "Homework Answer Key — 0.2", file: "files/Precalc_Unit0_Homework_0.2_Answer_Key.pdf" },
          { label: "Notes Filled In — 0.2", file: "files/Precalc_Unit0_Notes_0.2_Filled_In.pdf" },
          { label: "Homework Answer Key — 0.3", file: "files/Precalc_Unit0_Homework_0.3_Answer_Key.pdf" },
          { label: "Notes Filled In — 0.3", file: "files/Precalc_Unit0_Notes_0.3_Filled_In.pdf" },
          { label: "Homework Answer Key — 0.4", file: "files/Precalc_Unit0_Homework_0.4_Answer_Key.pdf" },
          { label: "Notes Filled In — 0.4", file: "files/Precalc_Unit0_Notes_0.4_Filled_In.pdf" },
          { label: "Homework Answer Key — 0.5", file: "files/Precalc_Unit0_Homework_0.5_Answer_Key.pdf" },
          { label: "Notes Filled In — 0.5", file: "files/Precalc_Unit0_Notes_0.5_Filled_In.pdf" },
          { label: "Homework Answer Key — 0.6", file: "files/Precalc_Unit0_Homework_0.6_Answer_Key.pdf" },
          { label: "Notes Filled In — 0.6", file: "files/Precalc_Unit0_Notes_0.6_Filled_In.pdf" },
    ...
    // NOTE: Aug 18 (Renaissance Testing) and Aug 19 (finishing 0.1) pushed
    // everything from 0.2 onward back by 2 school days. To keep Semester 1
    // Finals on their real fixed dates, Semester 1 Review was trimmed from 5
    // days to 3 to absorb the shift (same fix used for the Lots of
    // Dots/Rainbow Logic insertion at the start of the year).
    units: [
      {
        id: "unit0",
        name: "Unit 0: Prerequisites",
        schedule: [
          ...
          { date: "2026-08-18", type: "test", label: "Renaissance Testing" },
          { date: "2026-08-19", type: "lesson", label: "0.1 — The Cartesian Plane (finish)" },
          { date: "2026-08-20", type: "lesson", label: "0.2 — Equations of Circles" },
          { date: "2026-08-21", type: "homework", label: "" },
          { date: "2026-08-24", type: "lesson", label: "0.3 — Solving Equations in Multiple Representations" },
          { date: "2026-08-25", type: "lesson", label: "0.4 — Reasoning with Formulas" },
          { date: "2026-08-26", type: "homework", label: "" },
          { date: "2026-08-27", type: "homework", label: "" },
          { date: "2026-08-28", type: "quiz", label: "0.1–0.4" },
          { date: "2026-08-31", type: "lesson", label: "0.5 — Linear Relationships" },
          { date: "2026-09-01", type: "lesson", label: "0.6 — Reasoning with Slope" },
          { date: "2026-09-02", type: "lesson", label: "0.7 — Set Notation" },
          { date: "2026-09-03", type: "homework", label: "" },
          { date: "2026-09-04", type: "review", label: "Unit 0" },
          { date: "2026-09-08", type: "review", label: "Unit 0" },
          { date: "2026-09-09", type: "review", label: "Unit 0" },
          { date: "2026-09-10", type: "test", label: "Unit 0 — Day 1" },
          { date: "2026-09-11", type: "test", label: "Unit 0 — Day 2" }
        ]
      },
      {
        id: "unit1",
        name: "Unit 1: Functions",
        schedule: [
          { date: "2026-09-14", type: "lesson", label: "1.1 — Functions and Function Notation" },
          { date: "2026-09-15", type: "homework", label: "" },
          { date: "2026-09-16", type: "lesson", label: "1.2 — Domain and Range" },
          { date: "2026-09-17", type: "homework", label: "" },
          { date: "2026-09-18", type: "lesson", label: "1.3 — Rates of Change and Graph Behavior" },
          { date: "2026-09-21", type: "homework", label: "" },
          { date: "2026-09-22", type: "lesson", label: "1.4 — Library of Parent Functions" },
          { date: "2026-09-23", type: "homework", label: "" },
          { date: "2026-09-24", type: "lesson", label: "1.5 — Transformations of Functions" },
          ...
          { date: "2026-10-09", type: "lesson", label: "1.8 — Compositions of Functions" },
          { date: "2026-10-13", type: "homework", label: "" },
          { date: "2026-10-14", type: "lesson", label: "1.9 — Inverse Functions" },
          { date: "2026-10-15", type: "homework", label: "" },
          { date: "2026-10-16", type: "lesson", label: "1.10 — Graphs of Inverse Functions" },
          { date: "2026-10-19", type: "homework", label: "" },
          { date: "2026-10-20", type: "lesson", label: "1.11 — Piecewise Functions" },
          { date: "2026-10-21", type: "homework", label: "" },
          { date: "2026-10-22", type: "review", label: "Unit 1" },
          { date: "2026-10-26", type: "test", label: "Unit 1 — Day 1" },
          { date: "2026-10-27", type: "test", label: "Unit 1 — Day 2" },
        ]
      },
      {
        id: "unit2",
        ...
        schedule: [
          { date: "2026-10-28", type: "lesson", label: "2.1 — Connecting Quadratics" },
          { date: "2026-10-29", type: "homework", label: "" },
          { date: "2026-10-30", type: "lesson", label: "2.2 — Completing the Square" },
          { date: "2026-11-02", type: "homework", label: "" },
          { date: "2026-11-03", type: "lesson", label: "2.3 — Polynomials in the Short Run" },
          { date: "2026-11-04", type: "homework", label: "" },
          { date: "2026-11-05", type: "lesson", label: "2.4 — Polynomials in the Long Run" },
          { date: "2026-11-06", type: "homework", label: "" },
          { date: "2026-11-09", type: "quiz", label: "2.1–2.4" },
          { date: "2026-11-10", type: "lesson", label: "2.5 — Factor and Remainder Theorem" },
          { date: "2026-11-11", type: "homework", label: "" },
          { date: "2026-11-12", type: "lesson", label: "2.5 Day 2 — Factor and Remainder Theorem" },
          { date: "2026-11-16", type: "homework", label: "" },
          { date: "2026-11-17", type: "lesson", label: "2.6 — Complex Zeros" },
          { date: "2026-11-18", type: "homework", label: "" },
          { date: "2026-11-19", type: "lesson", label: "2.7 — Connecting Zeros Across Multiple Representations" },
          { date: "2026-11-20", type: "homework", label: "" },
          { date: "2026-11-30", type: "lesson", label: "2.8 — Intro to Rational Functions" },
          { date: "2026-12-01", type: "homework", label: "" },
          { date: "2026-12-02", type: "lesson", label: "2.9 — Graphing Rational Functions" },
          { date: "2026-12-03", type: "homework", label: "" },
          { date: "2026-12-07", type: "review", label: "Unit 2" },
          { date: "2026-12-08", type: "test", label: "Unit 2 — Day 1" },
          { date: "2026-12-09", type: "test", label: "Unit 2 — Day 2" },
        ]
      },
      {
        id: "unit3",
        ...
        schedule: [
          { date: "2026-12-10", type: "lesson", label: "3.1 — Exponential Functions" },
          { date: "2026-12-11", type: "homework", label: "" },
          { date: "2026-12-14", type: "lesson", label: "3.2 — Graphs of Exponential Functions" },
          { date: "2026-12-15", type: "homework", label: "" },
          { date: "2027-01-05", type: "lesson", label: "Unit 3 continues (3.3 onward: Compound Interest and \"e\", Logarithmic Functions, Log Properties, Solving Exponential/Log Equations, Modeling, Review, and Test) — to be scheduled closer to that time" }
        ]
      },
      {
        id: "sem1-finals",
  ...
  apcalc: {
    ...
    // Full-year tentative pacing plan (from Calculus_Pacing_Plan_2026-2027_DRAFT.docx).
    // Lesson numbers here (1.1, 2.9, 6.12, ...) are the textbook/homework lesson
    // numbers used for day-to-day pacing — NOT the AP CED topic numbers (1.1-1.16
    // etc.) used in the Unit Resources / Guided Notes / DeltaMath crosswalk below.
    // Two rows are still flagged from the draft review and need Mrs. Nield's
    // confirmation: Sep 14 (test date conflict resolved by moving the 2.4 review
    // here) and Jan 5 (assumed first 3 days back from break are review, 6.5 starts
    // Jan 8). Update the label text once confirmed.
    courseCalendar: [
      {
        id: "sw1", name: "1st Six Weeks (Aug 13 – Sep 18)",
        schedule: [
          { date: "2026-08-13", type: "note", label: "First day of school" },
          { date: "2026-08-14", type: "lesson", label: "1.1" },
          { date: "2026-08-17", type: "lesson", label: "1.2" },
          { date: "2026-08-18", type: "review", label: "Review" },
          { date: "2026-08-19", type: "lesson", label: "1.5" },
          { date: "2026-08-20", type: "lesson", label: "1.6" },
          { date: "2026-08-21", type: "lesson", label: "1.7" },
          { date: "2026-08-24", type: "review", label: "Review" },
          { date: "2026-08-25", type: "lesson", label: "1.8" },
      ...
      {
        id: "sw3", name: "3rd Six Weeks (Nov 2 – Dec 18, incl. Final Exam)",
        schedule: [
          ...
          { date: "2026-11-11", type: "lesson", label: "5.3" },
          { date: "2026-11-12", type: "lesson", label: "5.4" },
          { date: "2026-11-13", type: "no-school", label: "No school" },
          { date: "2026-11-16", type: "review", label: "Review" },
          { date: "2026-11-17", type: "lesson", label: "5.5" },
          { date: "2026-11-18", type: "lesson", label: "5.6" },
          { date: "2026-11-19", type: "lesson", label: "5.7" },
          { date: "2026-11-20", type: "review", label: "Review" },
          { date: "2026-11-23", type: "no-school", label: "Thanksgiving break (Nov 23–27)" },
          { date: "2026-11-30", type: "review", label: "Review" },
          { date: "2026-12-01", type: "lesson", label: "5.8" },
          { date: "2026-12-02", type: "review", label: "Review" },
          ...
          { date: "2026-12-15", type: "lesson", label: "6.3" },
          { date: "2026-12-16", type: "lesson", label: "6.4" },
          { date: "2026-12-17", type: "final", label: "End of 3rd six weeks / Final exam" },
          { date: "2026-12-18", type: "final", label: "Final exam" },
          { date: "2026-12-21", type: "no-school", label: "Christmas break begins (Dec 21 – Jan 4)" }
        ]
      },
      {
        id: "sw4", name: "4th Six Weeks (Jan 5 – Feb 11)",
        schedule: [
          { date: "2027-01-05", type: "review", label: "First day back / Review (please confirm — assumes Jan 5–7 are review, 6.5 starts Jan 8)" },
          { date: "2027-01-06", type: "review", label: "Review" },
          { date: "2027-01-07", type: "review", label: "Review" },
          { date: "2027-01-08", type: "lesson", label: "6.5" },
          { date: "2027-01-11", type: "lesson", label: "6.6" },
          { date: "2027-01-12", type: "lesson", label: "6.7" },
          { date: "2027-01-13", type: "lesson", label: "6.8" },
          { date: "2027-01-14", type: "lesson", label: "6.9" },
          { date: "2027-01-15", type: "no-school", label: "No school" },
          { date: "2027-01-18", type: "no-school", label: "No school" },
          { date: "2027-01-19", type: "review", label: "Review" },
          { date: "2027-01-20", type: "lesson", label: "6.10" },
          { date: "2027-01-21", type: "review", label: "Review" },
          ...
          { date: "2027-02-03", type: "lesson", label: "8.2" },
          { date: "2027-02-04", type: "lesson", label: "8.3" },
          { date: "2027-02-05", type: "review", label: "Review" },
          { date: "2027-02-08", type: "lesson", label: "8.4" },
          { date: "2027-02-09", type: "lesson", label: "8.5" },
          { date: "2027-02-10", type: "review", label: "Review" },
          { date: "2027-02-11", type: "lesson", label: "8.6 — End of 4th six weeks" }
        ]
      },
      {
        id: "sw5", name: "5th Six Weeks, in progress (Feb 16 – Mar 19)",
        schedule: [
          { date: "2027-02-16", type: "review", label: "Review — Start of 5th six weeks" },
          ...
          { date: "2027-02-26", type: "no-school", label: "No students" },
          { date: "2027-03-01", type: "lesson", label: "7.2" },
          { date: "2027-03-02", type: "review", label: "Review" },
          { date: "2027-03-03", type: "lesson", label: "7.3" },
    ...
    units: [
      ...
      },
      {
        ...
        resources: [
          ...
          { label: "Unit 1 Review (video)", file: "https://youtu.be/d7jI8OXhSVw" }
        ]
      },
      {
        id: "unit2",

    ...
    units: [
      {
        ...
        schedule: [
          ...
          { date: "2026-09-08", type: "test", label: "Unit 0 — Day 1" },
          { date: "2026-09-09", type: "test", label: "Unit 0 — Day 2" }
        ]
      },
      {
        id: "unit1",
        ...
        schedule: [
          { date: "2026-09-10", type: "lesson", label: "1.1 — Functions and Function Notation" },
          { date: "2026-09-11", type: "lesson", label: "1.2 — Domain and Range" },
          { date: "2026-09-14", type: "lesson", label: "1.3 — Rates of Change and Graph Behavior" },
          { date: "2026-09-15", type: "homework", label: "" },
          { date: "2026-09-16", type: "lesson", label: "1.4 — Library of Parent Functions" },
          { date: "2026-09-17", type: "lesson", label: "1.5 — Transformations of Functions" },
          { date: "2026-09-18", type: "homework", label: "" },
          { date: "2026-09-21", type: "lesson", label: "1.5 Day 2 — Transformations of Functions" },
          { date: "2026-09-22", type: "lesson", label: "1.6 — Even and Odd Functions" },
          { date: "2026-09-23", type: "homework", label: "" },
          { date: "2026-09-24", type: "quiz", label: "1.1–1.6" },
          { date: "2026-09-28", type: "lesson", label: "1.7 — Building Functions" },
          { date: "2026-09-29", type: "lesson", label: "1.8 — Compositions of Functions" },
          { date: "2026-09-30", type: "lesson", label: "1.9 — Inverse Functions" },
          { date: "2026-10-01", type: "homework", label: "" },
          { date: "2026-10-05", type: "lesson", label: "1.10 — Graphs of Inverse Functions" },
          { date: "2026-10-06", type: "lesson", label: "1.11 — Piecewise Functions" },
          { date: "2026-10-07", type: "homework", label: "" },
          { date: "2026-10-08", type: "review", label: "Unit 1" },
          { date: "2026-10-09", type: "test", label: "Unit 1 — Day 1" },
          { date: "2026-10-13", type: "test", label: "Unit 1 — Day 2" },
        ]
      },
      {
        id: "unit2",
        ...
        schedule: [
          { date: "2026-10-14", type: "lesson", label: "2.1 — Connecting Quadratics" },
          { date: "2026-10-15", type: "lesson", label: "2.2 — Completing the Square" },
          { date: "2026-10-16", type: "homework", label: "" },
          { date: "2026-10-19", type: "lesson", label: "2.3 — Polynomials in the Short Run" },
          { date: "2026-10-20", type: "lesson", label: "2.4 — Polynomials in the Long Run" },
          { date: "2026-10-21", type: "homework", label: "" },
          { date: "2026-10-22", type: "quiz", label: "2.1–2.4" },
          { date: "2026-10-26", type: "lesson", label: "2.5 — Factor and Remainder Theorem" },
          { date: "2026-10-27", type: "lesson", label: "2.5 Day 2 — Factor and Remainder Theorem" },
          { date: "2026-10-28", type: "lesson", label: "2.6 — Complex Zeros" },
          { date: "2026-10-29", type: "homework", label: "" },
          { date: "2026-11-02", type: "lesson", label: "2.7 — Connecting Zeros Across Multiple Representations" },
          { date: "2026-11-03", type: "lesson", label: "2.8 — Intro to Rational Functions" },
          { date: "2026-11-04", type: "lesson", label: "2.9 — Graphing Rational Functions" },
          { date: "2026-11-05", type: "homework", label: "" },
          { date: "2026-11-06", type: "review", label: "Unit 2" },
          { date: "2026-11-09", type: "test", label: "Unit 2 — Day 1" },
          { date: "2026-11-10", type: "test", label: "Unit 2 — Day 2" },
        ]
      },
      {
        id: "unit3",
        ...
        schedule: [
          { date: "2026-11-11", type: "lesson", label: "3.1 — Exponential Functions" },
          { date: "2026-11-12", type: "lesson", label: "3.2 — Graphs of Exponential Functions" },
          { date: "2026-11-16", type: "lesson", label: "3.3 — Compound Interest and an Introduction to \"e\"" },
          { date: "2026-11-17", type: "homework", label: "" },
          { date: "2026-11-18", type: "quiz", label: "3.1–3.3" },
          { date: "2026-11-19", type: "lesson", label: "3.4 — Logarithmic Functions" },
          { date: "2026-11-20", type: "lesson", label: "3.5 — Graphs of Logarithmic Functions" },
          { date: "2026-11-30", type: "homework", label: "" },
          { date: "2026-12-01", type: "lesson", label: "3.6 — Logarithm Properties" },
          { date: "2026-12-02", type: "lesson", label: "3.7 — Solving Exponential and Logarithmic Equations" },
          { date: "2026-12-03", type: "homework", label: "" },
          { date: "2026-12-07", type: "lesson", label: "3.8 — Exponential and Logarithmic Modeling" },
          { date: "2026-12-08", type: "homework", label: "" },
          { date: "2026-12-09", type: "review", label: "Unit 3" },
          { date: "2026-12-10", type: "test", label: "Unit 3 — Day 1" },
          { date: "2026-12-11", type: "test", label: "Unit 3 — Day 2" },
        ]
      },
      {
        id: "sem1-review",
        ...
        schedule: [
          { date: "2026-12-14", type: "review", label: "Day 1" },
          { date: "2026-12-15", type: "review", label: "Day 2" },
        ]
      },
      {
        id: "sem1-finals",
